  ...
  <div class="app-container">
    ...
    <div class="container-form-table">
      ...
      >
        ...
        <el-table-column label="Thời gian mua hàng" prop="createdAt" sortable="custom" align="center" width="200">
          <template slot-scope="{row}">
      ...
      >
        <el-row :gutter="40">
          <el-col :span="12">
            ...
            <div style="margin-top: 20px;">Địa chỉ: {{ odDetail.order.address }}</div>
          </el-col>
          <el-col :span="12">
...
import { orderGetAllPageAtTheCounter, orderGetDetailById, orderChangeStatus } from '@/api/order'
...
export default {
  ...
  methods: {
    getList() {
      ...
      orderGetAllPageAtTheCounter(this.listQuery).then(res => {
        setTimeout(() => {
