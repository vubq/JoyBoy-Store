...
public class ProductController extends BaseController {
    ...
    @GetMapping("get-top-5-product-best-selling")
    public Response getTop5ProductBestSelling() {
        List<Product> listProduct = this.productService.getTop5ProductBestSelling();
        List<ProductWebViewDto> listProductWebViewDto = new ArrayList<>();
        listProduct.forEach(p -> {
            ProductWebViewDto productWebViewDto = ProductWebViewDto.builder()
                    .id(p.getId())
